...
| **S3 (BYO)** | Customer (e.g., GoTo) | Customer-controlled | Customer pays | Enterprise, data sovereignty |
...
| `enterprise` | Local + BYO S3 | GoTo, enterprises with data policies |
...
- **Enterprise users (GoTo)**: Get model improvements from the community WITHOUT sharing any of their data
...
### 9.7 Federated + Enterprise: The GoTo Scenario
...
5. Community model gets better from GoTo's gradient contributions (without seeing GoTo's data).
