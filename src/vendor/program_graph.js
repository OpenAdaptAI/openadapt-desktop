/* VENDORED from openadapt-flow: openadapt_flow/visualize/static/program_graph.js
 * DO NOT EDIT the internals of this file. It is the shared, dependency-free
 * program-graph renderer used by three surfaces (flow CLI, this desktop view,
 * cloud). Keep it in sync with upstream; re-vendor rather than patch here.
 * Only this header comment was added on vendoring. */
